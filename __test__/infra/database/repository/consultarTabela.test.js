...
const Repository = require("../../../../src/infra/database/repository/consultarTabela");
const Dynamo = require("../../../../src/infra/database/dynamo");

var context;

describe('consultarTabela', () => {
    ...
    it("Deve executar com sucesso", async () =>{
        let data = {}
        const resposta = await Repository.consultarTabela("teste","teste")
    ...
    test("Deve executar com Erro", async () => {
      let data = {}
      const resposta = await Repository.consultarTabela(null, null);
      console.log("Retorno da resposta" + JSON.stringify(resposta))
